...
## ⚠️ Rus tili uchun shrift (MUHIM)

Repo bilan birga **`fonts/`** papkasi ham keladi (`DejaVuSans.ttf`, `DejaVuSans-Bold.ttf`). Bu — PDF shartnomalarda rus tilidagi (kirill) ism va matnlar to'g'ri chiqishi uchun zarur. `fonts/` papkasini `bot.py` bilan **bir xil papkada**, xuddi shu holicha GitHub'ga yuklashni unutmang — aks holda dastur ishlayveradi, lekin rus tilidagi PDF matnlar noto'g'ri chiqib qolishi mumkin.
