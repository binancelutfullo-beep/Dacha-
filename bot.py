...
MENU_ITEMS_FILE = os.path.join(DATA_DIR, "menu_items.json")
...
TEXTS = {
    "uz": {
        ...
        "new_admin_booking_pending": "🆕 Yangi bron so'rovi (owner tasdig'ini kutmoqda)!\n\n🏡 {dacha}\n📅 {checkin} - {checkout}\n👤 {name}\n📞 {phone}\n💰 Summa: {total:,} so'm | Komissiya: {commission:,} so'm\n🆔 User: {user_id}",
        "owner_booking_request": "🔔 Yangi bron so'rovi!\n\n🏡 {dacha}\n📅 {checkin} - {checkout}\n👤 {name}\n📞 {phone}\n💰 Summa: {total:,} so'm | Komissiya: {commission:,} so'm\n\nUshbu sanalar bo'sh ekanligini tasdiqlaysizmi?",
        "booking_pending_owner": "⏳ So'rovingiz dacha egasiga yuborildi. U tasdiqlagach, sizga xabar beramiz.",
        "booking_approved_guest": "✅ Broningiz dacha egasi tomonidan tasdiqlandi! Shartnoma PDF fayli yuborildi.",
        "booking_rejected_guest": "❌ Afsuski, ushbu sanalar uchun dacha bo'sh emas ekan. Boshqa sana yoki boshqa dacha tanlang:",
        "rebook_new_dates_btn": "📅 Boshqa sana tanlash",
        "rebook_other_dacha_btn": "📋 Boshqa dacha tanlash",
        ...
        "pending_owner_tag": " (⏳ owner tasdig'ini kutmoqda)",
    ...
    "ru": {
        ...
        "new_admin_booking_pending": "🆕 Новый запрос на бронь (ожидает подтверждения владельца)!\n\n🏡 {dacha}\n📅 {checkin} - {checkout}\n👤 {name}\n📞 {phone}\n💰 Сумма: {total:,} сум | Комиссия: {commission:,} сум\n🆔 User: {user_id}",
        "owner_booking_request": "🔔 Новый запрос на бронь!\n\n🏡 {dacha}\n📅 {checkin} - {checkout}\n👤 {name}\n📞 {phone}\n💰 Сумма: {total:,} сум | Комиссия: {commission:,} сум\n\nПодтверждаете, что эти даты свободны?",
        "booking_pending_owner": "⏳ Ваш запрос отправлен владельцу дачи. Как только он подтвердит, мы вам сообщим.",
        "booking_approved_guest": "✅ Ваша бронь подтверждена владельцем дачи! Договор отправлен файлом PDF.",
        "booking_rejected_guest": "❌ К сожалению, на эти даты дача не свободна. Выберите другую дату или другую дачу:",
        "rebook_new_dates_btn": "📅 Выбрать другую дату",
        "rebook_other_dacha_btn": "📋 Выбрать другую дачу",
        ...
        "pending_owner_tag": " (⏳ ожидает подтверждения владельца)",
...
A = {
    ...
    # --- Pastki menyu tugmalarini boshqarish ---
    "btn_menu_items": "🧩 Pastki menyuni boshqarish",
    "mi_panel_title": "🧩 Pastki menyu tugmalari. Har birini alohida boshqarishingiz mumkin:",
    "mi_children_title": "«{label}» ichidagi tugmalar:",
    "mi_rename_btn": "✏️ Nomini o'zgartirish",
    "mi_content_btn": "📝 Matnini o'zgartirish",
    "mi_toggle_btn": "🔁 Yoqish/o'chirish",
    "mi_toggled": "Holat o'zgartirildi.",
    "mi_open_btn": "📂 Ichiga kirish",
    "mi_addchild_btn": "➕ Ichiga tugma qo'shish",
    "mi_add_top_btn": "➕ Yangi tugma qo'shish",
    "mi_delete_btn": "🗑 O'chirish",
    "mi_delete_confirm": "❗️ «{label}» tugmasini rostdan ham o'chirmoqchimisiz?",
    "mi_delete_warning_builtin": "\n\n⚠️ Diqqat: bu — botning asosiy funksional tugmasi (masalan dachalar ro'yxati). O'chirsangiz, foydalanuvchilar shu funksiyaga pastki menyudan kira olmay qoladi.",
    "mi_delete_confirm_btn": "✅ Ha, o'chirish",
    "mi_deleted": "🗑 O'chirildi.",
    "mi_not_found": "Bu tugma topilmadi (o'chirilgan bo'lishi mumkin).",
    "mi_ask_label": "Yangi nomni kiriting:",
    "mi_ask_content": "Yangi matnni kiriting:",
    "mi_updated": "✅ Yangilandi!",
    "mi_ask_new_label": "1/2. Yangi tugma nomini kiriting (masalan: 📞 Aloqa):",
    "mi_ask_new_content": "2/2. Bu tugma bosilganda chiqadigan matnni kiriting:",
    "mi_added": "✅ Yangi tugma qo'shildi!",
    ...
    "already_cancelled": "Bu bron allaqachon hal qilingan.",
    ...
    "commission_global_pause_btn": "⏸⏸ Komissiyani HAMMA uchun to'xtatish",
    "commission_global_resume_btn": "▶️▶️ Komissiyani HAMMA uchun yoqish",
    "commission_global_paused": "⏸ Komissiya barcha owner'lar uchun to'xtatildi.",
    "commission_global_resumed": "▶️ Komissiya barcha owner'lar uchun qayta yoqildi.",
    "owner_booking_approve_btn": "✅ Tasdiqlash (joy bo'sh)",
    "owner_booking_reject_btn": "❌ Rad etish (joy band)",
    "owner_booking_approved": "✅ Bron tasdiqlandi. Mehmonga xabar berildi.",
    "owner_booking_rejected": "❌ Bron rad etildi. Mehmonga boshqa sana/dacha tanlash taklif qilindi.",
...
DEFAULT_MENU_ITEMS = {
    "list_dachas": {"label": "📋 Dachalar ro'yxati", "type": "builtin", "action": "list_dachas", "enabled": True, "content": None, "children": {}},
    "my_bookings": {"label": "🗂 Mening bronlarim", "type": "builtin", "action": "my_bookings", "enabled": True, "content": None, "children": {}},
    "support": {"label": "🆘 Yordam", "type": "builtin", "action": "support", "enabled": True, "content": None, "children": {}},
    "about": {"label": "ℹ️ Biz haqimizda", "type": "custom", "action": None, "enabled": True, "content": DEFAULT_ABOUT_TEXT, "children": {}},
    "travel": {"label": "✈️ Travel", "type": "custom", "action": None, "enabled": True, "content": "🚧 Bu bo'lim tez orada qo'shiladi.", "children": {}},
}


def load_menu_items() -> dict:
    return _load(MENU_ITEMS_FILE, DEFAULT_MENU_ITEMS)


def save_menu_items(items: dict):
    _save(MENU_ITEMS_FILE, items)


def get_menu_node(items: dict, path: list):
    """Berilgan yo'l (masalan ['about', 'contact']) bo'yicha ichma-ich joylashgan
    menyu elementini va uning ota-lug'atini qaytaradi: (node, parent_children_dict) yoki (None, None)."""
    node = None
    current = items
    for pid in path:
        node = current.get(pid)
        if node is None:
            return None, None
        current = node.setdefault("children", {})
    parent_dict = items
    for pid in path[:-1]:
        parent_dict = parent_dict[pid]["children"]
    return node, parent_dict


class MenuLabelFilter(BaseFilter):
    """Pastki panel tugmalari endi admin tomonidan dinamik o'zgartirilishi mumkin,
    shuning uchun statik F.text.in_(...) o'rniga har safar joriy nomlarni tekshiradi."""

    async def __call__(self, message: Message) -> bool:
        if not message.text:
            return False
        items = load_menu_items()
        labels = {i["label"] for i in items.values() if i.get("enabled", True)}
...
def load_settings() -> dict:
    return _load(SETTINGS_FILE, {"commission_globally_enabled": True})
...
def is_commission_globally_enabled() -> bool:
    return load_settings().get("commission_globally_enabled", True)
...
def get_commission_rate(owner_id) -> float:
    ...
    Agar admin komissiyani GLOBAL ravishda (barcha uchun) yoki shu owner uchun
    alohida vaqtincha O'CHIRGAN bo'lsa — 0 qaytaradi (asl foiz saqlanib qoladi,
    qayta yoqilganda tiklanadi)."""
    if not is_commission_globally_enabled():
        return 0.0
    if not owner_id:
...
def my_bookings_text(lang: str, user_bookings: list) -> str:
    ...
    for b in user_bookings:
        if b.get("status") == "cancelled":
            tag = t["cancelled_tag"]
        elif b.get("status") == "pending_owner":
            tag = t["pending_owner_tag"]
        else:
            tag = ""
...
def my_bookings_kb(lang: str, user_bookings: list):
    ...
    for b in user_bookings:
        ...
        if status == "active" and b["id"] not in reviewed_ids:
            rows.append(
...
def admin_panel_kb() -> InlineKeyboardMarkup:
    return InlineKeyboardMarkup(
        inline_keyboard=[
            ...
            [InlineKeyboardButton(text=A["btn_menu_items"], callback_data="admin_menu_items")],
...
async def _run_menu_action(action: str, message: Message, state: FSMContext):
    data = await state.get_data()
    lang = get_lang(data)
    await state.set_state(None)
    await state.update_data(lang=lang)

    if action == "list_dachas":
        dachas = load_dachas()
        if not dachas:
...
def custom_menu_children_kb(item_id: str, children: dict) -> InlineKeyboardMarkup:
    rows = [
        [InlineKeyboardButton(text=child["label"], callback_data=f"mi:{item_id}.{cid}")]
        for cid, child in children.items() if child.get("enabled", True)
    ]
    return InlineKeyboardMarkup(inline_keyboard=rows) if rows else None


@router.message(MenuLabelFilter())
async def dynamic_menu_handler(message: Message, state: FSMContext):
    items = load_menu_items()
    item_id, item = next(
        ((iid, i) for iid, i in items.items() if i.get("enabled", True) and i["label"] == message.text), (None, None)
    )
    if not item:
        return

    if item["type"] == "builtin":
        await _run_menu_action(item["action"], message, state)
        return

    # Maxsus (custom) tugma — matn ko'rsatiladi, agar "ichki" tugmalari bo'lsa ular ham chiqadi
    children = item.get("children", {})
    kb = custom_menu_children_kb(item_id, children)
    await message.answer(item.get("content") or item["label"], reply_markup=kb)


@router.callback_query(F.data.startswith("mi:"))
async def menu_item_navigate(callback: CallbackQuery, state: FSMContext):
    path = callback.data[3:].split(".")
    items = load_menu_items()
    node, _ = get_menu_node(items, path)
    if not node:
        await callback.answer("Topilmadi.", show_alert=True)
        return
    children = node.get("children", {})
    kb = custom_menu_children_kb(callback.data[3:], children)
    # Orqaga tugmasi: agar ichkarida bo'lsak, ota-menyuga qaytaramiz
    back_rows = []
    if len(path) > 1:
        parent_path = ".".join(path[:-1])
        back_rows.append([InlineKeyboardButton(text="⬅️ Orqaga", callback_data=f"mi:{parent_path}")])
    rows = (kb.inline_keyboard if kb else []) + back_rows
    final_kb = InlineKeyboardMarkup(inline_keyboard=rows) if rows else None
    await safe_edit_text(callback, node.get("content") or node["label"], reply_markup=final_kb)
    await callback.answer()
...
async def confirm_booking(callback: CallbackQuery, state: FSMContext, bot: Bot):
    ...
    booking = {
        ...
        "status": "pending_owner" if owner_id else "active",
    ...
    if owner_id:
        # Dacha egasi tasdiqlashi kerak — mehmonga hozircha "so'rov yuborildi" deb aytamiz
        await safe_edit_text(callback, TEXTS[lang]["booking_pending_owner"])

        owner_text = TEXTS["uz"]["owner_booking_request"].format(
            dacha=d["name_uz"], checkin=data["checkin"], checkout=data["checkout"],
            name=data["name"], phone=data["phone"], total=total, commission=commission,
        )
        kb = InlineKeyboardMarkup(
            inline_keyboard=[[
                InlineKeyboardButton(text=A["owner_booking_approve_btn"], callback_data=f"ownerbook_yes_{booking['id']}"),
                InlineKeyboardButton(text=A["owner_booking_reject_btn"], callback_data=f"ownerbook_no_{booking['id']}"),
            ]]
        )
        try:
            await bot.send_message(owner_id, owner_text, reply_markup=kb)
        except Exception as e:
            logging.warning(f"Dacha egasiga ({owner_id}) so'rov yuborilmadi: {e}")

        for admin_id in ADMIN_IDS:
            admin_text = TEXTS["uz"]["new_admin_booking_pending"].format(
                dacha=d["name_uz"], checkin=data["checkin"], checkout=data["checkout"],
                name=data["name"], phone=data["phone"], total=total, commission=commission,
                user_id=callback.from_user.id,
            )
    ...
    # Owner'siz (admin/platforma) dachalar uchun — avvalgidek darhol tasdiqlanadi
...
@router.callback_query(F.data.startswith("ownerbook_yes_"))
async def owner_booking_approve(callback: CallbackQuery, state: FSMContext, bot: Bot):
    booking_id = callback.data.replace("ownerbook_yes_", "")
    bookings = load_bookings()
    ...
    if not d or d.get("owner_id") != callback.from_user.id:
        await callback.answer(A["not_admin"], show_alert=True)
        return
    if booking["status"] != "pending_owner":
        await callback.answer(A["already_cancelled"], show_alert=True)
        return
    ...
    guest_lang = booking.get("lang", "uz")
    try:
        pdf_path = generate_guest_contract_pdf(
            booking["name"], booking["dacha"], booking["checkin"], booking["checkout"], booking["user_id"]
        )
        await bot.send_document(booking["user_id"], FSInputFile(pdf_path))
        await bot.send_message(booking["user_id"], TEXTS[guest_lang]["booking_approved_guest"])
    except Exception as e:
        logging.warning(f"Mehmonga ({booking['user_id']}) tasdiqlash xabari yuborilmadi: {e}")

    await safe_edit_text(callback, A["owner_booking_approved"])
    await callback.answer()


@router.callback_query(F.data.startswith("ownerbook_no_"))
async def owner_booking_reject(callback: CallbackQuery, state: FSMContext, bot: Bot):
    booking_id = callback.data.replace("ownerbook_no_", "")
    bookings = load_bookings()
    booking = next((b for b in bookings if b["id"] == booking_id), None)
    if not booking:
        await callback.answer(A["ticket_not_found"], show_alert=True)
    ...
    kb = InlineKeyboardMarkup(
        inline_keyboard=[
            [InlineKeyboardButton(
                text=TEXTS[guest_lang]["rebook_new_dates_btn"], callback_data=f"rebookdates_{booking['dacha_key']}"
            )],
            [InlineKeyboardButton(text=TEXTS[guest_lang]["rebook_other_dacha_btn"], callback_data="menu_list")],
        ]
    )
    try:
        await bot.send_message(booking["user_id"], TEXTS[guest_lang]["booking_rejected_guest"], reply_markup=kb)
    except Exception as e:
        logging.warning(f"Mehmonga ({booking['user_id']}) rad etish xabari yuborilmadi: {e}")

    await safe_edit_text(callback, A["owner_booking_rejected"])
    await callback.answer()


@router.callback_query(F.data.startswith("rebookdates_"))
async def rebook_new_dates(callback: CallbackQuery, state: FSMContext):
    data = await state.get_data()
    lang = get_lang(data)
    dacha_key = callback.data.replace("rebookdates_", "")
    dachas = load_dachas()
    ...
    await state.update_data(dacha_key=dacha_key)
    await state.set_state(BookingStates.entering_checkin)
    await callback.message.answer(TEXTS[lang]["ask_checkin"], reply_markup=cancel_kb(lang))
    await callback.answer()
...
def commissions_list_kb(owners: dict) -> InlineKeyboardMarkup:
    global_enabled = is_commission_globally_enabled()
    global_toggle_text = A["commission_global_pause_btn"] if global_enabled else A["commission_global_resume_btn"]
    rows = [[InlineKeyboardButton(text=global_toggle_text, callback_data="ctoggle_global")]]
...
@router.callback_query(F.data == "ctoggle_global")
async def commission_toggle_global(callback: CallbackQuery, state: FSMContext):
    if not is_admin(callback.from_user.id):
        await callback.answer(A["not_admin"], show_alert=True)
        return
    settings = load_settings()
    current = settings.get("commission_globally_enabled", True)
    settings["commission_globally_enabled"] = not current
    save_settings(settings)
    msg = A["commission_global_paused"] if current else A["commission_global_resumed"]
    await callback.answer(msg, show_alert=True)
    owners = load_owners()
    await safe_edit_text(
        callback,
        A["commissions_title"].format(default=f"{COMMISSION_RATE * 100:g}"),
        reply_markup=commissions_list_kb(owners),
    )
...
# --- Pastki menyu tugmalarini boshqarish (to'liq, admin uchun) ---
def menu_items_admin_kb(items: dict, path: list) -> InlineKeyboardMarkup:
    rows = []
    for iid, item in items.items():
        status = "✅" if item.get("enabled", True) else "⛔️"
        kind = "" if item["type"] == "builtin" else ""
        child_count = len(item.get("children", {}))
        child_tag = f" ({child_count} ta ichki)" if child_count else ""
        rows.append([InlineKeyboardButton(text=f"{status} {item['label']}{child_tag}", callback_data="noop")])
        p = ".".join(path + [iid])
        row1 = [
            InlineKeyboardButton(text=A["mi_rename_btn"], callback_data=f"mirename:{p}"),
            InlineKeyboardButton(text=A["mi_toggle_btn"], callback_data=f"mitoggle:{p}"),
        ]
        rows.append(row1)
        row2 = []
        if item["type"] == "custom":
            row2.append(InlineKeyboardButton(text=A["mi_content_btn"], callback_data=f"micontent:{p}"))
            row2.append(InlineKeyboardButton(text=A["mi_addchild_btn"], callback_data=f"miaddchild:{p}"))
        rows.append(row2) if row2 else None
        row3 = []
        if item.get("children"):
            row3.append(InlineKeyboardButton(text=A["mi_open_btn"], callback_data=f"miopen:{p}"))
        row3.append(InlineKeyboardButton(text=A["mi_delete_btn"], callback_data=f"midelete:{p}"))
        rows.append(row3)
    rows.append([InlineKeyboardButton(text=A["mi_add_top_btn"], callback_data=f"miaddtop:{'.'.join(path)}")])
    back_cb = "admin_panel" if not path else f"miopen:{'.'.join(path[:-1])}" if len(path) > 1 else "admin_menu_items"
    rows.append([InlineKeyboardButton(text=A["back"], callback_data=back_cb)])
    return InlineKeyboardMarkup(inline_keyboard=rows)


@router.callback_query(F.data == "admin_menu_items")
async def admin_menu_items(callback: CallbackQuery, state: FSMContext):
    if not is_admin(callback.from_user.id):
        await callback.answer(A["not_admin"], show_alert=True)
        return
    items = load_menu_items()
    await safe_edit_text(callback, A["mi_panel_title"], reply_markup=menu_items_admin_kb(items, []))
    await callback.answer()


@router.callback_query(F.data.startswith("miopen:"))
async def mi_open(callback: CallbackQuery, state: FSMContext):
    if not is_admin(callback.from_user.id):
        await callback.answer(A["not_admin"], show_alert=True)
        return
    path_str = callback.data.replace("miopen:", "")
    ...
    if not node:
        ...
        return
    await safe_edit_text(
        callback, A["mi_children_title"].format(label=node["label"]),
        reply_markup=menu_items_admin_kb(node.get("children", {}), path),
    )
    await callback.answer()


@router.callback_query(F.data.startswith("mitoggle:"))
async def mi_toggle(callback: CallbackQuery, state: FSMContext):
    if not is_admin(callback.from_user.id):
        await callback.answer(A["not_admin"], show_alert=True)
        return
    path = callback.data.replace("mitoggle:", "").split(".")
    items = load_menu_items()
    node, _ = get_menu_node(items, path)
    if not node:
        await callback.answer("Topilmadi.", show_alert=True)
    ...
    await callback.answer(A["mi_toggled"], show_alert=True)
    parent_path = path[:-1]
    parent_items, _ = (items, None) if not parent_path else (get_menu_node(items, parent_path)[0]["children"], None)
    await safe_edit_text(
        callback,
        A["mi_panel_title"] if not parent_path else A["mi_children_title"].format(label=get_menu_node(items, parent_path)[0]["label"]),
        reply_markup=menu_items_admin_kb(parent_items, parent_path),
    )


@router.callback_query(F.data.startswith("midelete:"))
async def mi_delete(callback: CallbackQuery, state: FSMContext):
    if not is_admin(callback.from_user.id):
        await callback.answer(A["not_admin"], show_alert=True)
        return
    path = callback.data.replace("midelete:", "").split(".")
    items = load_menu_items()
    node, parent_dict = get_menu_node(items, path)
    if not node:
        await callback.answer("Topilmadi.", show_alert=True)
        return
    warn = A["mi_delete_warning_builtin"] if node["type"] == "builtin" else ""
    kb = InlineKeyboardMarkup(
        inline_keyboard=[[
            InlineKeyboardButton(text=A["mi_delete_confirm_btn"], callback_data=f"midelyes:{'.'.join(path)}"),
            InlineKeyboardButton(text=A["cancel_operation_btn"], callback_data=f"miopen:{'.'.join(path[:-1])}"),
        ]]
    )
    await safe_edit_text(
        callback, A["mi_delete_confirm"].format(label=node["label"]) + warn, reply_markup=kb
    )
    await callback.answer()


@router.callback_query(F.data.startswith("midelyes:"))
async def mi_delete_confirm(callback: CallbackQuery, state: FSMContext):
    if not is_admin(callback.from_user.id):
        await callback.answer(A["not_admin"], show_alert=True)
        return
    path = callback.data.replace("midelyes:", "").split(".")
    items = load_menu_items()
    parent_path = path[:-1]
    if not parent_path:
        items.pop(path[-1], None)
        save_menu_items(items)
        await safe_edit_text(callback, A["mi_deleted"], reply_markup=menu_items_admin_kb(items, []))
    else:
        parent_node, _ = get_menu_node(items, parent_path)
        parent_node["children"].pop(path[-1], None)
        save_menu_items(items)
        await safe_edit_text(
            callback, A["mi_deleted"],
            reply_markup=menu_items_admin_kb(parent_node["children"], parent_path),
        )
    await callback.answer()


@router.callback_query(F.data.startswith("mirename:"))
async def mi_rename_start(callback: CallbackQuery, state: FSMContext):
    if not is_admin(callback.from_user.id):
        await callback.answer(A["not_admin"], show_alert=True)
        return
    path = callback.data.replace("mirename:", "")
    await state.update_data(mi_path=path, mi_action="rename")
    await state.set_state(MenuItemStates.editing_field)
    await safe_edit_text(callback, A["mi_ask_label"], reply_markup=cancel_kb("uz"))
    await callback.answer()


@router.callback_query(F.data.startswith("micontent:"))
async def mi_content_start(callback: CallbackQuery, state: FSMContext):
    if not is_admin(callback.from_user.id):
        await callback.answer(A["not_admin"], show_alert=True)
        return
    path = callback.data.replace("micontent:", "")
    await state.update_data(mi_path=path, mi_action="content")
    await state.set_state(MenuItemStates.editing_field)
    await safe_edit_text(callback, A["mi_ask_content"], reply_markup=cancel_kb("uz"))
    await callback.answer()


@router.message(MenuItemStates.editing_field)
async def mi_field_save(message: Message, state: FSMContext):
    data = await state.get_data()
    path = data["mi_path"].split(".")
    action = data["mi_action"]
    items = load_menu_items()
    node, _ = get_menu_node(items, path)
    if not node:
        await state.set_state(None)
        await message.answer(A["mi_not_found"], reply_markup=admin_panel_kb())
        return
    if action == "rename":
        node["label"] = message.text.strip()
    else:
        node["content"] = message.text.strip()
    save_menu_items(items)
    await state.set_state(None)
    parent_path = path[:-1]
    parent_items = items if not parent_path else get_menu_node(items, parent_path)[0]["children"]
    await message.answer(A["mi_updated"], reply_markup=menu_items_admin_kb(parent_items, parent_path))


@router.callback_query(F.data.startswith("miaddchild:"))
async def mi_addchild_start(callback: CallbackQuery, state: FSMContext):
    if not is_admin(callback.from_user.id):
        await callback.answer(A["not_admin"], show_alert=True)
        return
    path = callback.data.replace("miaddchild:", "")
    await state.update_data(mi_parent_path=path)
    await state.set_state(MenuItemStates.adding_label)
    await safe_edit_text(callback, A["mi_ask_new_label"], reply_markup=cancel_kb("uz"))
    await callback.answer()


@router.callback_query(F.data.startswith("miaddtop:"))
async def mi_addtop_start(callback: CallbackQuery, state: FSMContext):
    if not is_admin(callback.from_user.id):
        await callback.answer(A["not_admin"], show_alert=True)
        return
    path = callback.data.replace("miaddtop:", "")
    await state.update_data(mi_parent_path=path)
    await state.set_state(MenuItemStates.adding_label)
    await safe_edit_text(callback, A["mi_ask_new_label"], reply_markup=cancel_kb("uz"))
    await callback.answer()
...
@router.message(MenuItemStates.adding_label)
async def mi_add_label(message: Message, state: FSMContext):
    await state.update_data(mi_new_label=message.text.strip())
    await state.set_state(MenuItemStates.adding_content)
    await message.answer(A["mi_ask_new_content"], reply_markup=cancel_kb("uz"))


@router.message(MenuItemStates.adding_content)
async def mi_add_content(message: Message, state: FSMContext):
    data = await state.get_data()
    parent_path_str = data.get("mi_parent_path", "")
    parent_path = parent_path_str.split(".") if parent_path_str else []
    items = load_menu_items()
    new_id = uuid.uuid4().hex[:6]
    new_item = {
        "label": data["mi_new_label"], "type": "custom", "action": None,
        "enabled": True, "content": message.text.strip(), "children": {},
    }
    if not parent_path:
        ...
        parent_node, _ = get_menu_node(items, parent_path)
        parent_node.setdefault("children", {})[new_id] = new_item
        save_menu_items(items)
        target_items, target_path = parent_node["children"], parent_path
    await state.set_state(None)
    await message.answer(A["mi_added"], reply_markup=menu_items_admin_kb(target_items, target_path))
